...
class TestSalaryCompare:
    ...
    def test_salary_are_equals_none_with_currency(self):
    ...
    def test_salary_are_equals_not_none_with_currency(self):
    ...
    def test_1(self):
        """
        Если указанна только минимальная зарплата у обеих зарплат, то сравнивается по ней
        """
